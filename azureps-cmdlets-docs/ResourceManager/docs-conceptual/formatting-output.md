...
| <span data-ttu-id="da5f2-106">Formatowanie</span><span class="sxs-lookup"><span data-stu-id="da5f2-106">Formatting</span></span>      | <span data-ttu-id="da5f2-107">Konwersja</span><span class="sxs-lookup"><span data-stu-id="da5f2-107">Conversion</span></span>       |
|-----------------|------------------|
...
<span data-ttu-id="da5f2-111">Jeśli chcesz ograniczyć zwracane kolumny, możesz użyć polecenia cmdlet `Format-Table`.</span><span class="sxs-lookup"><span data-stu-id="da5f2-111">If you would like to limit the columns returned you can use the `Format-Table` cmdlet.</span></span> <span data-ttu-id="da5f2-112">W kolejnym przykładzie zostanie pobrana ta sama lista maszyn wirtualnych, ale dane wyjściowe zostaną ograniczone tylko do nazwy i lokalizacji maszyny wirtualnej oraz grupy zasobów.</span><span class="sxs-lookup"><span data-stu-id="da5f2-112">In the following example we get the same list of virtual machines but restrict the output to just the name of the VM, the resource group, and the location of the VM.</span></span>  <span data-ttu-id="da5f2-113">Parametr `-Autosize` umożliwia zmienianie rozmiaru kolumn na podstawie rozmiaru danych.</span><span class="sxs-lookup"><span data-stu-id="da5f2-113">The `-Autosize` parameter sizes the columns according to the size of the data.</span></span>
...
<span data-ttu-id="da5f2-114">Jeśli chcesz, możesz jednak wyświetlić informacje w formacie listy.</span><span class="sxs-lookup"><span data-stu-id="da5f2-114">If you would prefer you can view information in a list format.</span></span> <span data-ttu-id="da5f2-115">Pokazano to w poniższym przykładzie, korzystającym z polecenia cmdlet `Format-List`.</span><span class="sxs-lookup"><span data-stu-id="da5f2-115">The following example shows this using the`Format-List` cmdlet.</span></span>
...
<span data-ttu-id="da5f2-119">Dane wyjściowe można także przekształcić na format JSON.</span><span class="sxs-lookup"><span data-stu-id="da5f2-119">You can also convert the output into JSON format.</span></span>  <span data-ttu-id="da5f2-120">W poniższym przykładzie zostanie utworzona ta sama lista maszyn wirtualnych, ale format danych wyjściowych zostanie zmieniony na JSON.</span><span class="sxs-lookup"><span data-stu-id="da5f2-120">The following example creates the same list of VMs but changes the output format to JSON.</span></span>
